@extends('layouts.app')
@section('title')
    Nuestros Servicios - Desarrollos QV
@endsection
@section('content')
        ...
        <div class="container py-14 pt-md-16">
            <div class="row align-items-center mb-10">
                <div class="col-md-8 col-lg-9 col-xl-8 col-xxl-7 pe-xl-20">
                    <h2 class="display-4 mb-3">Conoce nuestros proyectos</h2>
                    <p class="lead fs-20 mb-0">Echa un vistazo a algunos de nuestros últimos proyectos con ideas creativas..</p>
                </div>
                <!--/column -->
            </div>
            <!--/.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-4 pb-12 align-self-center">
                            ...
                            <p>Maecenas faucibus mollis interdum sed posuere consectetur est at lobortis. Scelerisque id
                                ligula porta felis euismod semper. Fusce dapibus tellus cursus.</p>
                            <a href="#" class="more hover link-violet">See Project</a>
                        </div>
                        <!-- /column -->
                        <div class="col-lg-7 offset-lg-1 align-self-end">
                            <figure><img class="img-fluid" src="{{ asset('assets/img/photos/f1.png') }}"
                                    srcset="{{ asset('assets/img/photos/f1@2x.png 2x') }}" alt="" /></figure>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
            ...
            <div class="card bg-soft-blue mb-10">
                <div class="card-body p-12">
                    <div class="row gy-10 align-items-center">
                        ...
                        <!-- /column -->
                        <div class="col-lg-7">
                            <figure><img class="img-fluid" src="{{ asset('assets/img/photos/f2.png') }}"
                                    srcset="{{ asset('assets/img/photos/f2@2x.png 2x') }}" alt="" /></figure>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
            ...
            <div class="row gx-md-8 gx-xl-10">
                <div class="col-lg-6">
                    <div class="card bg-soft-leaf mb-10">
                        ...
                        <!--/.card-body -->
                        <img class="card-img-bottom" src="{{ asset('assets/img/photos/f3.png') }}"
                            srcset="{{ asset('assets/img/photos/f3@2x.png 2x') }}" alt="" />
                    </div>
                    <!--/.card -->
                </div>
                <!-- /column -->
                <div class="col-lg-6">
                    <div class="card bg-soft-pink">
                        ...
                        <!--/.card-body -->
                        <img class="card-img-bottom" src="{{ asset('assets/img/photos/f4.png') }}"
                            srcset="{{ asset('assets/img/photos/f4@2x.png 2x') }}" alt="" />
                    </div>
                    <!--/.card -->
                </div>
                <!-- /column -->
